...
from .views import (List_Motorcycle , Create_Motorcycle,
                    ...
                    View_Motorcycle_Price, User_List)
urlpatterns = [
    ...
    path('update_motorcycle/<int:pk>',Update_Motorcycle.as_view(),name="update_motorcycle"),
    path('delete_motorcycle/<int:pk>',Delete_Motorcycle.as_view(),name='delete_motorcycle'),
    path('retrieve_motorcycle/<int:pk>',Retrieve_Motorcycle.as_view(),name='retrieve_motorcycle'),
